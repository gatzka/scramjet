...
if(NOT DEFINED CTEST_BINARY_DIRECTORY)
  set(CTEST_BINARY_DIRECTORY "/tmp/scramjet/")
endif()
...
if(CTEST_CONFIGURATION_TYPE STREQUAL "Coverage" AND GCOVR_BIN)
    ...
    set(CTEST_CUSTOM_POST_TEST
        ...
        "${GCOVR_BIN} --html --html-details --html-title scramjet -f ${CTEST_SCRIPT_DIRECTORY}/lib/\\* -e ${CTEST_SCRIPT_DIRECTORY}/lib/scramjet/http-parser/\\* -e ${CTEST_SCRIPT_DIRECTORY}/lib/miniz/\\* -e ${CTEST_SCRIPT_DIRECTORY}/lib/scramjet/sha1/\\* --exclude-directories .\\*CompilerIdC\\* -r ${CTEST_SCRIPT_DIRECTORY} --object-directory=${CIO_OBJECT_DIRECTORY} -o ${CIO_CTEST_COVERAGE_DIR}/index.html")
